...
class RewardsEngine:
    """
    Motor de Automação Soberano v5.5.
    Engenharia de Elite validada empiricamente para crédito de pontos.
    """
    ...
    async def initialize(self, headless: bool = True, user_agent: str = None, is_mobile: bool = False):
        ...
        # Hardware real para bypass de telemetria
    ...
    async def perform_search(self, keywords: List[str], is_mobile: bool = False):
        """Buscas com cadência soberana para garantir o crédito."""
